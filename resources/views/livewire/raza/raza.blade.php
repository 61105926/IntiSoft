        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one"
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Razas</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        <button type="button"
                            ...
                            <i class="fa fa-paw"></i> Añadir Raza
                        </button>
                    </div>
                    <div class="col-6">
            ...
            <div id="invoice-list_wrapper"
                ...
                <div class="table-responsive">
                    <table id="invoice-list"
                        ...
                        <tbody>
                            @forelse ($data as $raza)
                                <tr>
                                    <td>{{ $raza->id }}</td>
                                    <td>{{ $raza->nombre }}</td>
                                    <td>{{ $raza->especie->nombre }}</td> <!-- Mostrar el nombre de la especie -->
                                    <!-- Estado -->
