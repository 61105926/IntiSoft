...
// Top End
document
    .querySelector(".widget-content .top-end")
...
// Bottom Start
/* document
    .querySelector(".widget-content .bottom-start")
    .addEventListener("click", function () {
        Swal.fire({
...
// Bottom End
document
    .querySelector(".widget-content .bottom-end")
    .addEventListener("click", function () {
        Swal.fire({
            position: "bottom-end",
            icon: "success",
...
document
    .querySelector(".widget-content .timer")
    .addEventListener("click", function () {
        let timerInterval;
        Swal.fire({
...
document
    .querySelector(".widget-content .custom-image")
    .addEventListener("click", function () {
        Swal.fire({
            title: "Sweet!",
...
document
    .querySelector(".widget-content .warning.confirm")
    .addEventListener("click", function () {
        Swal.fire({
            title: "Are you sure?",
...
document
    .querySelector(".widget-content .warning.cancel")
    .addEventListener("click", function () {
        Swal.fire({
            title: "Are you sure?",
            text: "You won't be able to revert this!",
...
/* document
    .querySelector(".widget-content .RTL")
    .addEventListener("click", function () {
        Swal.fire({
...
document
    .querySelector(".widget-content .mixin")
    .addEventListener("click", function () {
...
/* // Succcess
document
    .querySelector(".widget-content .icon-success")
    .addEventListener("click", function () {
        Swal.fire({
            icon: "success",
            title: "Icon Success",
...
// Error
document
    .querySelector(".widget-content .icon-error")
    .addEventListener("click", function () {
        Swal.fire({
            icon: "error",
            title: "Icon Error",
...
// Warning
document
    .querySelector(".widget-content .icon-warning")
    .addEventListener("click", function () {
        Swal.fire({
            icon: "warning",
            title: "Icon Warning",
...
// Info
document
    .querySelector(".widget-content .icon-info")
    .addEventListener("click", function () {
        Swal.fire({
            icon: "info",
            title: "Icon Info",
...
// Question
document
    .querySelector(".widget-content .icon-question")
    .addEventListener("click", function () {
        Swal.fire({
            icon: "question",
            title: "Icon Question",
